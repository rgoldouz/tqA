...
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/TOP_TW_CH/" + file )
f.closed

#for file in Filestbar:
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("T-W-CH.root")
)
