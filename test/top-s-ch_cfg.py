...
#Filestbar = listFiles("/eos/cms/store/user/rgoldouz/singletop/tbar_s_chanel/"
#)
f = open('topS.txt', 'r')
inputs = (x for x in f.readlines())
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SECONDTOP_S_CH/" + file )
f.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("T-S-CH.root")
)
