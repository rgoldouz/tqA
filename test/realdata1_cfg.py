...
#File2 = listFiles("/eos/cms/store/user/mojtaba/SingleMu_Run2012A_recover_06Aug2012_v1_AOD/")
#for file in File2:
#       process.source.fileNames.append( "root://eoscms/" + file )


#File1 = listFiles("/eos/cms/store/user/mojtaba/SingleMu_Run2012C_24Aug2012_v1_AOD/")
#for file in File1:
#        process.source.fileNames.append( "root://eoscms/" + file )

f = open('runA24AUG.txt', 'r')
inputs = (x for x in f.readlines())
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SingleMu_Run2012A_recover_06Aug2012_v1_AOD/" + file )
f.closed
...
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SingleMu_Run2012C_24Aug2012_v1_AOD/" + file )
f.closed
...
files = [file.strip() for file in inputs]
for file in files:
	process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SingleMu_Run2012A_13Jul2012-v1_AOD/" + file )
f.closed
...
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SingleMu_Run2012B_13Jul2012_v1_AOD/" + file )
f.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("REALDATA1.root")
)
