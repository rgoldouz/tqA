...
f = open('signaltgcQup.txt', 'r')
inputs = (x for x in f.readlines())
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/tGc_scaleup/" + file )
f.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("SIGNALtGC_scaleup.root")
)
