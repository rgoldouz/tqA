...
#    fileNames = cms.untracked.vstring("rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/ZZ/susypat_94_1_Kb9.root")
                            )
...
for file in files:
	process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/ZZ/" + file )
f.closed
