...
#    fileNames = cms.untracked.vstring("rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/WW/susypat_86_1_g9R.root")
                           )
...
#   fileNames = cms.untracked.vstring("root://eoscms//eos/cms/store/user/rgoldouz/WW/susypat_34_1_H10.root")
#)
...
for file in files:
	process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/WW/" + file )
f.closed
