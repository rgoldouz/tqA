...
f = open('phjet50to80.txt', 'r')
inputs = (x for x in f.readlines())
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/G_Pt_50to80/" + file )
f.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("G_Pt_50to80.root")
)
