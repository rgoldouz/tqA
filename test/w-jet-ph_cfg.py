...
#    fileNames = cms.untracked.vstring("file:/afs/cern.ch/work/r/rgoldouz/ANALYZ/CMSSW_5_3_5/src/myanalysis/Atq/test/susypat_10_1_2h5.root")
                            )
f = open('wphj.txt', 'r')
inputs = (x for x in f.readlines())
files = [file.strip() for file in inputs]
for file in files:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/WPHOTONJET/" + file )
f.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("WPHJET.root")
)
...
process.STEP1=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , sample='wphjet')
process.STEP2=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , sample='wphjet')
process.STEP3=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , sample='wphjet')
process.STEP4=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , sample='wphjet', jets='goodJets')
process.STEP5=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , sample='wphjet')
process.STEP6=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , tops='top', step='afterb', sample='wphjet')
process.STEP7=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , tops='top', step='afterb', sample='wphjet')
process.STEP8=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , tops='top', step='afterb', sample='wphjet')


process.firstanalyzestep = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top', sample='wphjet')

process.analyzestep2  = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top', sample='wphjet')
process.Signalregion  = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top',treename='insidetopmass', sample='wphjet')
process.Sidebandregion  = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top',treename='outsidetopmass', sample='wphjet')
