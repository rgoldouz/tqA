...
d = open('newRUNd.txt', 'r')
dinputs = (x for x in d.readlines())
dfiles = [file.strip() for file in dinputs]
for file in dfiles:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SingleMu_Run2012D_22Jan2013_v1_AOD/" + file )
d.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("REALDATAd.root")
)
