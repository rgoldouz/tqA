...
for file in files:
        process.source.fileNames.append( "root://eoscms//eos/cms/store/user/rgoldouz/WJETTOLEPTON/" + file )
f.closed

#ff = open('wjet2.txt', 'r')
#inp = (x for x in ff.readlines())
#fil = [file.strip() for file in inp]
#for file in fil:
#        process.source.fileNames.append( "root://eoscms//eos/cms/store/user/mojtaba/SECONDWJET/" + file )
#ff.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("WJET1.root")
)
