...
#setenv DPNS_HOST se1.particles.ipm.ac.ir
#setenv DPM_HOST se1.particles.ipm.ac.ir
#setenv LD_LIBRARY_PATH  /home/goldouzian:${LD_LIBRARY_PATH}
cmsRun top-s-ch_cfg.py
