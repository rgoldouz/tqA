...
for file in dfiles:
        process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/SingleMu_Run2012C_PromptReco_v2_AOD/" + file )
d.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("REALDATA2.root")
)
