...
for file in files:
	process.source.fileNames.append( "rfio:///dpm/particles.ipm.ac.ir/home/cms/store/user/goldouzian/ZGtoLL/" + file )
f.closed
...
process.TFileService =cms.Service("TFileService",
      fileName =cms.string("ZGAMMA.root")
)
...
process.STEP1=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' ,sample='zphjet')
process.STEP2=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' ,sample='zphjet')
process.STEP3=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' ,sample='zphjet')
process.STEP4=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' ,sample='zphjet', jets='goodJets')
process.STEP5=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' ,sample='zphjet')
process.STEP6=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , tops='top', step='afterb',sample='zphjet')
process.STEP7=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , tops='top', step='afterb',sample='zphjet')
process.STEP8=firstselection.clone(photonsrc='Finalphoton' ,muons='tightMuons' , tops='top', step='afterb',sample='zphjet')


process.firstanalyzestep = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top',sample='zphjet')

process.analyzestep2  = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top',sample='zphjet')
process.Signalregion  = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top',treename='insidetopmass',sample='zphjet')
process.Sidebandregion  = analyzePatTopSelection.clone(photonsrc='Finalphoton' ,muons='tightMuons', jets='goodJets',mybjets='bJets',met='patMETsPF' ,tops='top',treename='outsidetopmass',sample='zphjet')
