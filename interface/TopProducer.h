...
#include "myanalysis/Atq/interface/EquationSolver.h"
...
//namespace pat {
  ...
  class TopProducer : public edm::EDProducer {
    ...
    private:
    std::pair<std::vector<math::XYZTLorentzVector>,double> Nu4Momentum(const reco::Candidate & Lepton,const reco::Candidate & MET);
    
    edm::InputTag muonsSrc_,jetsSrc_,bjetsSrc_,METsSrc_;
