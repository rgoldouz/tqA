...
sigma[idx]=X[idx]/(lumi*eff);
lambda[idx]=sqrt(sigma[idx]/33.9);
...
//   grafexp1sigma->
   ...
   grafexp2sigma->GetXaxis()->SetTitle("#lambda_{L} (#lambda_{R}=0)");
