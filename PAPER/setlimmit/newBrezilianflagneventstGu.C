...
#include "TLine.h"
#include "TPaveText.h"
void newBrezilianflagneventstGu(){

 TF1 *fa = new TF1("fa","67.2*x*x",0.001,0.05); 
...
*/
double X[N]={0.001,0.05};
double nO[N]={0.0287,0.0287};
double nE[N]={0.0448,0.0448};
...
double nE1sigmaup[N]={0.0631,0.0631};
double nE1sigmadown[N]={0.0353,0.0353};

double nE2sigmaup[N]={0.095,0.095};
double nE2sigmadown[N]={0.0283,0.0283};
double sigma1up[N];
double sigma1down[N];
double sigma2up[N];
double sigma2down[N];
