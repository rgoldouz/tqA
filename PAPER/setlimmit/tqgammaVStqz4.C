...
TF2 *f2 = new TF2("f2","[0]*pow(x,2)+[1]*pow(y,2)",0.0000001,0.05,0.0000001,0.12);
...
TF2 *fhera = new TF2("fhera","[0]*pow(x,2)+[1]*pow(y,2)",0.00001,0.06,0.00001,0.7);
...
double lepy2[4]={0,0.001,0.0012,0.001};
double lepx[4]={0,0.001,0.0011,0.0012};
double lepy[4]={0.1,0.1,0.1,0.1};

double herax2[4]={0.0060,0.0060,0.0060,0.0060};
double heray2[4]={0,0.01,0.01,0.01};

double herax[4]={0,0.00002,0.00021,0.00022};
double heray[4]={0.6,0.6,0.6,0.6};
...
pad1->cd();
 ...
 latex.DrawLatex(mycmsx[0]+mycmsx[0]/2,0.00013,"#splitline{#color[2]{     CMS}}{#color[2]{Preliminary}}");
 latex.DrawLatex(0.000014,heray[0]-heray[0]/5,"#color[6]{ZEUS (q=u)}");
...
//CMS tqgamma
   TLatex *   tex1 = new TLatex(0.00035,0.00004,"(m_{top}=172.5)");
   tex1->SetLineWidth(2);
   tex1->SetTextColor(2);
   tex1->SetTextSize(0.018);
   tex1->Draw();

//ZEUS
   TLatex *   tex3 = new TLatex(0.000064,0.35,"(m_{top}=175)");
   tex3->SetLineWidth(2);
   tex3->SetTextColor(6);
...
//H1
   TLatex *   tex4 = new TLatex(0.011,0.00004,"(m_{top}=175)");
   tex4->SetLineWidth(2);
   tex4->SetTextColor(28);
   tex4->SetTextSize(0.018);
   tex4->Draw();

//CDF
   TLatex *   tex5 = new TLatex(0.0000285,0.046,"(m_{top}=175)");
   tex5->SetLineWidth(2);
   tex5->SetTextColor(12);
   tex5->SetTextSize(0.018);
   tex5->Draw();

//LEP
   TLatex *   tex6 = new TLatex(0.000045,0.135,"(m_{top}=175)");
   tex6->SetLineWidth(2);
   tex6->SetTextColor(4);
   tex6->SetTextSize(0.018);
   tex6->Draw();

//CMS tqz
  TLatex *   tex7 = new TLatex(0.00003,0.00065,"(m_{top}=172.5)");
   tex7->SetLineWidth(1);
   tex7->SetTextColor(1);
   tex7->SetTextSize(0.018);
   tex7->Draw();

//ATLAS
 TLatex *   tex8 = new TLatex(0.000044,0.0094,"(m_{top}=172.5)");
   tex8->SetLineWidth(1);
   tex8->SetTextColor(46);
   tex8->SetTextSize(0.018);
   tex8->Draw();

//D0
 TLatex *   tex9 = new TLatex(0.000024,0.0234,"(m_{top}=175)");
   tex9->SetLineWidth(1);
   tex9->SetTextColor(3);
   tex9->SetTextSize(0.018);
   tex9->Draw();
