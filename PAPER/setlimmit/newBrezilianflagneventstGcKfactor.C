...
#include "TLine.h"
#include "TPaveText.h"
void newBrezilianflagneventstGcKfactor(){
...
double X[N]={0.001,0.13};
double nO[N]={0.0279 , 0.0279 };
double nE[N]={0.0410,0.0410};

cout<<"jadid"<<endl;
cout<<"expected tgammac coupling including k-factor"<<sqrt(1.5*nE[0]/(1.375*7.15))<<endl;
cout<<"observed tgammac coupling including k-factor"<<sqrt(1.5*nO[0]/(1.375*7.15))<<endl;
cout<<"ghadimi"<<endl;
...
double nE1sigmaup[N]={0.0574,0.0574};
double nE1sigmadown[N]={0.0294,0.0294};

double nE2sigmaup[N]={0.0839,0.0839};

double nE2sigmadown[N]={0.0243,0.0243};

cout<<"expected tgammac coupling including k-factor"<<sqrt(nE[0]/(1.375*7.15))<<endl;
cout<<"expected 1sigma up tgammac coupling including k-factor"<<sqrt(nE1sigmaup[0]/(1.375*7.15))<<endl;
cout<<"expected 1sigma down tgammac coupling including k-factor"<<sqrt(nE1sigmadown[0]/(1.375*7.15))<<endl;
cout<<"expected 2sigma up tgammac coupling including k-factor"<<sqrt(nE2sigmaup[0]/(1.375*7.15))<<endl;
cout<<"expected 2sigma down tgammac coupling including k-factor"<<sqrt(nE2sigmadown[0]/(1.375*7.15))<<endl;
