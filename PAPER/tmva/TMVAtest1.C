...
//  factory->AddVariable ("lbphmass", 'F');
...
//  factory->AddVariable ("deltaphiphotonmet", 'F');
  ...
  factory->AddVariable ("DeltaPhiPhotonTop", 'F');
//  factory->AddVariable ("CosWBjet", 'F');
  factory->AddVariable ("SumJetPt", 'F');
  factory->AddVariable ("DeltaRMuonNeutrino", 'F');
//  factory->AddVariable ("DeltaRMuonJet", 'F');
  factory->AddVariable ("PhotonMuonPtRatio", 'F');
//  factory->AddVariable ("PtTopPhoton", 'F');
//  factory->AddVariable ("PzTopPhoton", 'F');
...
if (!inputBTrain) {
  ...
  TTree *signalTrain      = (TTree*)inputSTrain->Get("analyzestep2/atq");
  TTree *backgroundTrain = (TTree*)inputBTrain->Get("analyzestep2/atq");

  TTree *ttbarbackground1 = (TTree*)inputBttbar1->Get("analyzestep2/atq");
  TTree *ttbarbackground2 = (TTree*)inputBttbar2->Get("analyzestep2/atq");
  TTree *ttbarbackground3 = (TTree*)inputBttbar3->Get("analyzestep2/atq");
  TTree *TTGbackground = (TTree*)inputTTG->Get("analyzestep2/atq");
  TTree *WWbackground = (TTree*)inputWW->Get("analyzestep2/atq");
  TTree *WZbackground = (TTree*)inputWZ->Get("analyzestep2/atq");
  TTree *ZZbackground = (TTree*)inputZZ->Get("analyzestep2/atq");
  TTree *ZGAMMAbackground = (TTree*)inputZGAMMA->Get("analyzestep2/atq");
...
factory->SetInputTrees(signalTrain,backgroundTrain,1,1.05);


 factory->AddBackgroundTree( ttbarbackground1, 1.09);
 factory->AddBackgroundTree( ttbarbackground2, 1.09);
 factory->AddBackgroundTree( ttbarbackground3, 1.09);
 factory->AddBackgroundTree( TTGbackground, 1.09);
...
factory->BookMethod( TMVA::Types::kBDT, "BDT",
                       "!H:!V:NTrees=400:BoostType=AdaBoost:AdaBoostBeta=0.7:MaxDepth=3:SeparationType=GiniIndex:PruneMethod=NoPruning" );
