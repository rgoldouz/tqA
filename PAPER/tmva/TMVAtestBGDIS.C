...
//  TFile *inputSTrain(0);
//  TFile *inputBTrain(0);
  TString sigFileTrain  = "etarev/REALDATA1.root";
  TString sigFileTrain2  = "etarev/REALDATA2.root";
  TString sigFileTrain3  = "etarev/REALDATA3.root";
...
//  TString bkgFileTrain = "TTG.root";
  ...
  TFile *inputSTrain2  = TFile::Open( sigFileTrain2 );
  TFile *inputSTrain3  = TFile::Open( sigFileTrain3 );
...
if (!inputBTrain) {
  ...
  TTree *signalTrain2      = (TTree*)inputSTrain2->Get("analyzestep2/atq");
  TTree *signalTrain3      = (TTree*)inputSTrain3->Get("analyzestep2/atq");
...
//cout<<"reza2";
 ...
 factory->AddSignalTree( signalTrain2, 1);
  factory->AddSignalTree( signalTrain3, 1);

// factory->AddBackgroundTree( ttbarbackground1, 0.15);
// factory->AddBackgroundTree( ttbarbackground2, 0.015);
// factory->AddBackgroundTree( ttbarbackground3, 0.09 );
...
//factory->BookMethod( TMVA::Types::kBDT, "BDT","!H:!V:NTrees=200:BoostType=AdaBoost:AdaBoostBeta=0.3:SeparationType=GiniIndex:nCuts=-1:PruneMethod=NoPruning" );
...
//  factory->BookMethod(TMVA::Types::kFisher, "Fisher", "H:!V:Fisher");   
 ...
 factory->BookMethod( TMVA::Types::kMLP, "MLP", "H:!V:NeuronType=tanh:VarTransform=N:NCycles=500:HiddenLayers=N+5:TestRate=5:!UseRegulator" ); 
