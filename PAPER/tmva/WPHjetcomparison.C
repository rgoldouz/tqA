...
float scales[] = {0.628,0.0978,34.01,6.133,1.04,0.32,0.02,0.002,0.0961,0.0253,0.0224,0.0145,0.0125,0.0160,0.0158,0.0341,0.0341,0.0341,0.020,0.0017,0.0055,0.0032,0.00084,0.02,0.032,0.024,0.0049094905};
...
TLegend* leg = new TLegend(0.4,0.6,0.6,0.90);
  ...
  leg->AddEntry( hists[26], "Signal(t#gammau)"               , "F");
...
*/
TCanvas *c2 = new TCanvas("c2","control region",200,10,700,500);
datahists[3]->Scale(1/datahists[3]->Integral());
SBhists[8]->Scale(1/SBhists[8]->Integral());
hists[8]->Scale(1/hists[8]->Integral());

hists[8]->SetLineColor(kRed);
SBhists[8]->SetLineColor(kBlue);
datahists[3]->SetLineColor(kGreen);
hists[8]->SetLineWidth(3.);
SBhists[8]->SetLineWidth(3.);
datahists[3]->SetLineWidth(3.);
datahists[3]->Draw("hist");
hists[8]->Draw("histsame");
SBhists[8]->Draw("histsame");
...
TLegend* leg = new TLegend(0.4,0.6,0.6,0.90);
  ...
  leg->SetFillColor ( 0);
  leg->SetBorderSize( 0);
  leg->AddEntry( SBhists[8], "w#gamma jets out of top window"               , "L");
  leg->AddEntry( hists[8], "w#gamma jets in top window"               , "L");
  leg->AddEntry( datahists[3], "CMS Data 2012(19.145/fb) out of top window"               , "L");
leg->Draw("same");
