...
using namespace std;
void BDToutputsideband2systematic() 
{   
#ifdef __CINT__
...
,0.020,0.0017,0.0055,0.0032,0.00084,0.02,0.01139,0.01139,1*(0.049094905/19.145)};
...
datahists[3]->Scale(1122.2/datahists[3]->Integral());
...
//  leg->AddEntry( signalhist2, "Signal(tc#gamma) 1 pb"               , "L");
...
h_ratio->GetYaxis()->SetTitle("DATA/MC");
  ...
  h_ratio->GetYaxis()->SetTitleSize(0.19);
...
TH1F *hnew = (TH1F*) datahists[3]->Clone("hnew");
hnew->Add(revDATAhists[3],-1);
hnew->Add(SBhists[1],-1);
hnew->Add(SBhists[2],-1);
for(unsigned int idx=9; idx<samples_.size()-1; ++idx){
hnew->Add(SBhists[idx],-1);}
for(unsigned int idx=1; idx<nbin; ++idx){
if (hnew->GetBinContent(idx)<0)hnew->SetBinContent(idx,0);
} 

TH1F *hnew2 = (TH1F*) datahists[3]->Clone("hnew2");
hnew2->Add(revDATAhists[3],-1);
hnew2->Add(SBhists[1],-1);
hnew2->Add(SBhists[2],-1);
for(unsigned int idx=9; idx<samples_.size(); ++idx){
hnew2->Add(SBhists[idx],-1);}
for(unsigned int idx=1; idx<nbin; ++idx){
if (hnew2->GetBinContent(idx)<0)hnew2->SetBinContent(idx,0);
} 
...
TCanvas *ctak = new TCanvas("ctak","signal region comparison",50,50,865,780);
ctak->cd();
//hnew->SetMaximum(1.2*hnew->GetMaximum());
hnew->SetLineColor(kRed);
hnew->SetLineWidth(2);
hnew->GetYaxis()->SetTitle("probability");
hnew->GetXaxis()->SetTitle("BDT output");
...
TLegend* leg2 = new TLegend(0.55,0.6,0.85,0.80);
  leg2->SetFillStyle ( 0);
  leg2->SetFillColor ( 0);
  leg2->SetBorderSize( 0);
  leg2->AddEntry( hnew, "data driven w+#gamma+jet shape"  , "L");
  leg2->AddEntry( hnew2, "data driven w+#gamma+jet shape signal included with #sigma = 0.1 pb" , "L");
...
ct->cd();
THStack *hs2 = new THStack("hs2","BDT output sideband");
//W+jet
revDATAhists[3]->SetFillColor(kBlue-2);
revDATAhists[3]->SetLineColor(kBlack);
hs2->Add(revDATAhists[3]);
//Z+jet
SBhists[1]->SetFillColor(kOrange-4);
SBhists[1]->SetLineColor(kBlack);
hs2->Add(hists[1]);
//photon+jet
SBhists[3]->Add(SBhists[2]);
SBhists[4]->Add(SBhists[3]);
SBhists[5]->Add(SBhists[4]);
SBhists[6]->Add(SBhists[5]);
SBhists[7]->Add(SBhists[6]);
SBhists[7]->SetFillColor(19);
//hs1->Add(hists[7]);
//W+photon+jet
SBhists[8]->SetFillColor(kGreen-3);
SBhists[8]->SetLineColor(kBlack);
//hs2->Add(SBhists[8]);

//single top+singletop photon
SBhists[5+5]->Add(SBhists[4+5]);
SBhists[6+5]->Add(SBhists[5+5]);
SBhists[7+5]->Add(SBhists[6+5]);
SBhists[8+5]->Add(SBhists[7+5]);
SBhists[9+5]->Add(SBhists[8+5]);
SBhists[19+5]->Add(SBhists[9+5]);
SBhists[20+5]->Add(SBhists[19+5]);
SBhists[20+5]->SetFillColor(kRed+3);
SBhists[20+5]->SetLineColor(kBlack);
hs2->Add(SBhists[20+5]);
//hists[9+5]->SetFillColor(kAzure+10);
//hs1->Add(hists[9+5]);

SBhists[11+5]->Add(SBhists[10+5]);
SBhists[12+5]->Add(SBhists[11+5]);
SBhists[13+5]->Add(SBhists[12+5]);
SBhists[13+5]->SetFillColor(kPink+1);
SBhists[13+5]->SetLineColor(kBlack);
hs2->Add(SBhists[13+5]);
//hists[13+5]->SetFillColor(17);
//hs1->Add(hists[13+5]);
//hists[14+5]->SetFillColor(kSpring-9);
//hs1->Add(hists[14+5]);
SBhists[15+5]->Add(SBhists[14+5]);
SBhists[16+5]->Add(SBhists[15+5]);
SBhists[17+5]->Add(SBhists[16+5]);
SBhists[17+5]->SetFillColor(kViolet-7);
SBhists[17+5]->SetLineColor(kBlack);
hs2->Add(SBhists[17+5]);
SBhists[18+5]->SetFillColor(kAzure+10);
SBhists[18+5]->SetLineColor(kBlack);
hs2->Add(SBhists[18+5]);
//hists[20+5]->Add(hists[19+5]);
//hists[20+5]->SetFillColor(kYellow+3);
//hs1->Add(hists[20+5]);

hs2->Draw("hist");
hs2->SetMaximum(1.2*datahists[3]->GetMaximum());
//hs1->GetXaxis()->SetTitle("BDT output");
hs2->GetYaxis()->SetTitle("Events / 0.1");
hs2->GetYaxis()->SetTitleSize(0.055*1.25);
hs2->GetYaxis()->SetTitleFont(22);
hs2->GetYaxis()->SetTitleOffset(0.6);
hs2->GetXaxis()->SetLabelSize(0.044);
hs2->GetXaxis()->SetTitle("BDT output");
hs2->GetXaxis()->SetTitleSize(0.055*1.25);
hs2->GetXaxis()->SetTitleFont(22);
hs2->GetXaxis()->SetTitleOffset(0.6);
hs2->GetXaxis()->SetLabelSize(0.044);

SBhists[21+5]->SetLineColor(kRed+3);
SBhists[21+5]->SetLineWidth(3);
SBhists[21+5]->Draw("histsame");
...
datahists[3]->SetMarkerSize(1.35);
