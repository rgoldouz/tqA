...
void rezamyTMVAClassificationApplication1( TString myMethodList = "" ) 
{   
#ifdef __CINT__
...
TH1F   *wphjethist(0), *zjethist(0) , *phjethist(0), *wjethist(0), *twchhist(0), *tbarwhist(0),  *tschhist(0), *tbarschhist(0), *ttchhist(0), *tbartchhist(0), *tt1hist(0) ,*tt2hist(0), *tt3hist(0), *ttphhist(0), *wwphhist(0), *wwhist(0), *wzhist(0), *zzhist(0), *zgammahist(0),*singletopphotonhist(0), *singleantitopphotonhist(0),  *signalhist(0) , *signalhist1(0);
...
signalhist1 = new TH1F( "mu_BDT__signal200",           "mu_BDT__signal200",           nbin, -1, 1 );
...
wphjethistplus = new TH1F( "mu_BDT__wphjethist__JES__plus",           "mu_BDT__wphjethist__JES__plus",           nbin, -1, 1 );
zjethistplus = new TH1F( "mu_BDT__zjethist__JES__plus",           "mu_BDT__zjethist__JES__plus",           nbin, -1, 1 );
phjethistplus = new TH1F( "mu_BDT__phjethist__JES__plus",           "mu_BDT__phjethist__JES__plus",           nbin, -1, 1 );
wjethistplus = new TH1F( "mu_BDT__wjethist__JES__plus",           "mu_BDT__wjethist__JES__plus",           nbin, -1, 1 );
twchhistplus = new TH1F( "mu_BDT__twchhist__JES__plus",           "mu_BDT__twchhist__JES__plus",           nbin, -1, 1 );
tbarwhistplus = new TH1F( "mu_BDT__tbarwhist__JES__plus",           "mu_BDT__tbarwhist__JES__plus",           nbin, -1, 1 );
tschhistplus = new TH1F( "mu_BDT__tschhist__JES__plus",           "mu_BDT__tschhist__JES__plus",           nbin, -1, 1 );
tbarschhistplus = new TH1F( "mu_BDT__tbarschhist__JES__plus",           "mu_BDT__tbarschhist__JES__plus",           nbin, -1, 1 );
ttchhistplus = new TH1F( "mu_BDT__ttchhist__JES__plus",           "mu_BDT__ttchhist__JES__plus",           nbin, -1, 1 );
tbartchhistplus = new TH1F( "mu_BDT__tbartchhist__JES__plus",           "mu_BDT__tbartchhist__JES__plus",           nbin, -1, 1 );
tt1histplus = new TH1F( "mu_BDT__tt1hist__JES__plus",           "mu_BDT__tt1hist__JES__plus",           nbin, -1, 1 );
tt2histplus = new TH1F( "mu_BDT__tt2hist__JES__plus",           "mu_BDT__tt2hist__JES__plus",           nbin, -1, 1 );
tt3histplus = new TH1F( "mu_BDT__tt3hist__JES__plus",           "mu_BDT__tt3hist__JES__plus",           nbin, -1, 1 );
ttphhistplus = new TH1F( "mu_BDT__ttphhist__JES__plus",           "mu_BDT__ttphhist__JES__plus",           nbin, -1, 1 );
wwphhistplus = new TH1F( "mu_BDT__wwphhist__JES__plus",           "BDT__wwphhist__JES__plus",           nbin, -1, 1 );
wwhistplus = new TH1F( "mu_BDT__wwhist__JES__plus",           "mu_BDT__wwhist__JES__plus",           nbin, -1, 1 );
wzhistplus = new TH1F( "mu_BDT__wzhist__JES__plus",           "mu_BDT__wzhist__JES__plus",           nbin, -1, 1 );
zzhistplus = new TH1F( "mu_BDT__zzhist__JES__plus",           "mu_BDT__zzhist__JES__plus",           nbin, -1, 1 );
zgammahistplus = new TH1F( "mu_BDT__zgammahist__JES__plus",           "mu_BDT__zgammahist__JES__plus",           nbin, -1, 1 );
signalhistplus = new TH1F( "mu_BDT__signal100__JES__plus",           "mu_BDT__signal100__JES__plus",           nbin, -1, 1 );
signalhistplus1 = new TH1F( "mu_BDT__signal200__JES__plus",           "mu_BDT__signal200__JES__plus",           nbin, -1, 1 );

wphjethistminus = new TH1F( "mu_BDT__wphjethist__JES__minus",           "mu_BDT__wphjethist__JES__minus",           nbin, -1, 1 );
zjethistminus = new TH1F( "mu_BDT__zjethist__JES__minus",           "mu_BDT__zjethist__JES__minus",           nbin, -1, 1 );
phjethistminus = new TH1F( "mu_BDT__phjethist__JES__minus",           "mu_BDT__phjethist__JES__minus",           nbin, -1, 1 );
wjethistminus = new TH1F( "mu_BDT__wjethist__JES__minus",           "mu_BDT__wjethist__JES__minus",           nbin, -1, 1 );
twchhistminus = new TH1F( "mu_BDT__twchhist__JES__minus",           "mu_BDT__twchhist__JES__minus",           nbin, -1, 1 );
tbarwhistminus = new TH1F( "mu_BDT__tbarwhist__JES__minus",           "mu_BDT__tbarwhist__JES__minus",           nbin, -1, 1 );
tschhistminus = new TH1F( "mu_BDT__tschhist__JES__minus",           "mu_BDT__tschhist__JES__minus",           nbin, -1, 1 );
tbarschhistminus = new TH1F( "mu_BDT__tbarschhist__JES__minus",           "mu_BDT__tbarschhist__JES__minus",           nbin, -1, 1 );
ttchhistminus = new TH1F( "mu_BDT__ttchhist__JES__minus",           "mu_BDT__ttchhist__JES__plus",           nbin, -1, 1 );
tbartchhistminus = new TH1F( "mu_BDT__tbartchhist__JES__minus",           "mu_BDT__tbartchhist__JES__plus",           nbin, -1, 1 );
tt1histminus = new TH1F( "mu_BDT__tt1hist__JES__minus",           "mu_BDT__tt1hist__JES__minus",           nbin, -1, 1 );
tt2histminus = new TH1F( "mu_BDT__tt2hist__JES__minus",           "mu_BDT__tt2hist__JES__minus",           nbin, -1, 1 );
tt3histminus = new TH1F( "mu_BDT__tt3hist__JES__minus",           "mu_BDT__tt3hist__JES__minus",           nbin, -1, 1 );
ttphhistminus = new TH1F( "mu_BDT__ttphhist__JES__minus",           "mu_BDT__ttphhist__JES__minus",           nbin, -1, 1 );
wwphhistminus = new TH1F( "mu_BDT__wwphhist__JES__minus",           "BDT__wwphhist__JES__minus",           nbin, -1, 1 );
wwhistminus = new TH1F( "mu_BDT__wwhist__JES__minus",           "mu_BDT__wwhist__JES__minus",           nbin, -1, 1 );
wzhistminus = new TH1F( "mu_BDT__wzhist__JES__minus",           "mu_BDT__wzhist__JES__minus",           nbin, -1, 1 );
zzhistminus = new TH1F( "mu_BDT__zzhist__JES__minus",           "mu_BDT__zzhist__JES__minus",           nbin, -1, 1 );
zgammahistminus = new TH1F( "mu_BDT__zgammahist__JES__minus",           "mu_BDT__zgammahist__JES__minus",           nbin, -1, 1 );
signalhistminus = new TH1F( "mu_BDT__signal100__JES__minus",           "mu_BDT__signal100__JES__minus",           nbin, -1, 1 );
signalhistminus1 = new TH1F( "mu_BDT__signal200__JES__minus",           "mu_BDT__signal200__JES__minus",           nbin, -1, 1 );
...
double wphjetscale=3173/(hists[3]->Integral()*scales[3]);
double wjetscale=620.32/(hists[0]->Integral()*scales[0]);
