...
//  TFile *inputSTrain(0);
//  TFile *inputBTrain(0);
  TString sigFileTrain  = "SIGNAL.root";
...
//				       ":nTrain_Signal=nSignalTrain:nTrain_Background=nBackTrain:!V");
  ...
  factory->BookMethod( TMVA::Types::kBDT, "BDT",
		       "!H:!V:NTrees=200:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=-1:NNodesMax=5:UseNvars=4:PruneStrength=5:PruneMethod=CostComplexity:MaxDepth=6" );
