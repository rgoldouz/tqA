...
using namespace std;
void BDToutputtopmasswindow2systematic() 
{   
#ifdef __CINT__
...
TPad *pad2 = new TPad("pad2","pad2",0,0.0,1,0.20);
pad2->SetFillStyle(0);
...
gae2->SetFillStyle(3003);
   ...
   gae->Draw("e2same");
TLegend* leg = new TLegend(0.61,0.37,0.85,0.87);
  leg->SetFillStyle ( 0);
  leg->SetFillColor ( 0);
  leg->SetBorderSize( 0);
  leg->AddEntry( datahists[2], "Data"               , "PL");
  leg->AddEntry( hists[23], "Z#gamma"               , "F");
  leg->AddEntry( hists[22], "Diboson, WW#gamma "               , "F");
  leg->AddEntry( hists[18], "t#bar{t}, t#bar{t}#gamma"               , "F");
  leg->AddEntry( hists[25], "Single t, Single t+#gamma"               , "F");
...
h_ratio->GetYaxis()->SetTitle("DATA/MC");
  ...
  h_ratio->GetXaxis()->SetLabelSize(0.21);
  h_ratio->GetYaxis()->SetLabelSize(0.13);
  h_ratio->GetYaxis()->SetTitleOffset(0.20);
h_ratio->GetXaxis()->SetTitleOffset(0.63);
