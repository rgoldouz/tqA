...
//  TFile *inputSTrain(0);
//  TFile *inputBTrain(0);
  TString sigFileTrain  = "SIGNALtGC.root";
...
//cout<<"reza2";
 ...
 factory->AddBackgroundTree( ttbarbackground1, 1);
 factory->AddBackgroundTree( ttbarbackground2, 1);
 factory->AddBackgroundTree( ttbarbackground3, 1);
