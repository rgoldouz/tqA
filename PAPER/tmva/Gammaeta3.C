...
TH1F *etadataSR = new TH1F("etadata","eta for DATA SIGNAL REGION",150,-3,3);
TH1F *phidataSR = new TH1F("phidata","phi for DATA SIGNAL REGION",150,-3,3);

TH1F *etadataCR = new TH1F("etadata","eta for DATA CONTROL REGION",150,-3,3);
TH1F *phidataCR = new TH1F("phidata","phi for DATA CONTROL REGION",150,-3,3);

TH2F *H_etaphiCR = new TH2F("H_etaphiCR","#eta vs #phi for DATA Control region",100,-3,3,100,-3,3);
TH2F *H_etaphiSR = new TH2F("H_etaphiSR","#eta vs #phi for DATA Signal region",100,-3,3,100,-3,3);
...
TH1F *etadata = new TH1F("etadata","eta for DATA in control region",50,-3,3);
TH1F *phidata = new TH1F("phidata","phi for DATA in control region",50,-3,3);
TH1F *ptdata = new TH1F("ptdata","pt for DATA in control region",50,0,500);
TH1F *HOEdata = new TH1F("HOEdata","HOE for DATA in control region",100,0,1);
TH1F *pfCHdata = new TH1F("pfCHdata","pfCH for DATA in control region",50,0,10);
TH1F *pfNUdata = new TH1F("pfNUdata","pfNU for DATA in control region",50,0,10);
TH1F *pfPHdata = new TH1F("pfPHdata","pfPH for DATA in control region",50,0,5);
TH1F *sigmaietaietadata = new TH1F("sigmaietaietadata","sigmaietaieta for DATA in control region",100,0,0.1);
...
hists[idx] ->Fill( (*myetaphoton)[0],finalweight );
...
SBhists[idx] ->Fill( (*myetaphoton)[0],finalweight );
...
if(sqrt(pow((*myetaphoton )[0]+1.76,2)+pow((*myphiphoton )[0]-1.37,2))>0.05 && sqrt(pow((*myetaphoton )[0]-2.37,2)+pow((*myphiphoton )[0]-2.69,2))>0.05){
//if(sqrt(pow((*myetaphoton )[0]- 1.6,2)+pow((*myphiphoton )[0]+2.1,2))>0.2 && sqrt(pow((*myetaphoton )[0]-1.65,2)+pow((*myphiphoton )[0]-2.1,2))>0.2){
if(sqrt(pow((*myetaphoton )[0]- 1.61,2)+pow((*myphiphoton )[0]+2.05,2))>0.05 && sqrt(pow((*myetaphoton )[0]-1.75,2)+pow((*myphiphoton )[0]-2.12,2))>0.05){
etadataSR->Fill(  (*myetaphoton)[0] );
phidataSR->Fill(  (*myphiphoton)[0] );

H_etaphiSR->Fill(  (*myetaphoton)[0], (*myphiphoton)[0]  );
...
//if(sqrt(pow((*myetaphoton )[0]- 1.6,2)+pow((*myphiphoton )[0]+2.1,2))>0.2 && sqrt(pow((*myetaphoton )[0]-1.65,2)+pow((*myphiphoton )[0]-2.1,2))>0.2){
if(sqrt(pow((*myetaphoton )[0]- 1.61,2)+pow((*myphiphoton )[0]+2.05,2))>0.05 && sqrt(pow((*myetaphoton )[0]-1.75,2)+pow((*myphiphoton )[0]-2.12,2))>0.05){
etadataCR->Fill(  (*myetaphoton)[0] );
phidataCR->Fill(  (*myphiphoton)[0] );
H_etaphiCR->Fill(  (*myetaphoton)[0], (*myphiphoton)[0]  );

if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup) {
etadata->Fill( (*myetaphoton )[0] );
phidata->Fill( (*myphiphoton )[0] );
...
revDATAhists[3]->Fill( (*myetaphoton)[0]);
}
}
}
...
revDATAhists[2]->Scale(262.63/revDATAhists[2]->Integral());
...
revDATAhists[3]->Scale(262.63/revDATAhists[3]->Integral());
...
datahists[3]->Scale(1069.70/datahists[3]->Integral());
...
hs1->Draw("hist");
hs1->SetMaximum(2*datahists[2]->GetMaximum());
//hs1->GetXaxis()->SetTitle("BDT output");
hs1->GetYaxis()->SetTitle("Events / 0.4");
hs1->GetYaxis()->SetTitleSize(0.055);
hs1->GetYaxis()->SetTitleFont(22);
hs1->GetYaxis()->SetTitleOffset(0.9);
hs1->GetYaxis()->SetLabelSize(0.044);
hs1->GetXaxis()->SetTitle("Photon #eta");
hs1->GetXaxis()->SetTitleSize(0.055);
hs1->GetXaxis()->SetTitleFont(22);
hs1->GetXaxis()->SetTitleOffset(0.9);
hs1->GetXaxis()->SetLabelSize(0.044);
...
gae2->SetFillStyle(3003);
 ...
 //  gae->Draw("e2same");
TLegend* leg = new TLegend(0.65,0.45,0.85,0.89);
  leg->SetFillStyle ( 0);
  leg->SetFillColor ( 0);
  leg->SetBorderSize( 0);
...
h_ratio->GetXaxis()->SetTitle("Photon #eta");
...
SBhists[20]->SetMaximum(1.65*datahists[3]->GetMaximum());
...
TLegend* leg = new TLegend(0.35,0.4,0.85,0.99);
  leg->SetFillStyle ( 0);
  leg->SetFillColor ( 0);
  leg->SetBorderSize( 0);
...
phidataSR->Draw();
 ...
 TCanvas *c64 = new TCanvas("c64","64",900,700);
  c64->cd(0);
etadataCR->Draw();

 TCanvas *c65 = new TCanvas("c65","65",900,700);
  c65->cd(0);
phidataCR->Draw();



 TCanvas *c66 = new TCanvas("c66","66",900,700);
  c66->cd(0);
H_etaphiCR->GetXaxis()->SetTitle("#eta ");
H_etaphiCR->GetYaxis()->SetTitle("#phi");
H_etaphiCR->Draw("colz");

 TCanvas *c67 = new TCanvas("c67","67",900,700);
  c67->cd(0);
H_etaphiSR->GetXaxis()->SetTitle("#eta ");
H_etaphiSR->GetYaxis()->SetTitle("#phi");
H_etaphiSR->Draw("colz");
...
etadata->Draw("");
  ...
  TCanvas *c360 = new TCanvas("c360","360",900,700);
  c360->cd(0);
phidata->GetXaxis()->SetTitle("#phi ");
phidata->GetYaxis()->SetTitle("NEvents");
phidata->Draw("");
