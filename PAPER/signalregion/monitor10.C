...
float scales[] = {0.628,0.0978,1.491,0.0961,0.0253,0.0224,0.0145,0.0125,0.0160,0.0158,0.0341,0.0341,0.0341,0.020,0.0017,0.0055,0.0032,0.00084,0.02,0.032,0.024,15.145*0.0169};
...
cout<<"   1  "<<endl;
hists_photonpt.push_back(new TH1F(  std::string("photon_pt").append(samples_[idx]).c_str(), std::string("photon_pt").append(samples_[idx]).c_str() , 16,0., 400.));
...
hists_photonpt.push_back(new TH1F(  std::string("photon_pt").append(datasamples_[idx]).c_str(), std::string("photon_pt").append(datasamples_[idx]).c_str() , 16,0., 400.));
...
hists_photonpt.push_back(new  TH1F(  std::string("photon_pt").append(datasamplesreverse_[idx]).c_str(), std::string("photon_pt").append(datasamplesreverse_[idx]).c_str() , 16,0., 400.));
...
double nwjet=212.609/hists_muoneta[0]->Integral();
hists_photonpt[0]->Scale(nwjet); 
hists_photoneta[0]->Scale(nwjet); 
hists_muonpt[0]->Scale(nwjet);
hists_muoneta[0]->Scale(nwjet); 
hists_jetpt[0]->Scale(nwjet);
hists_jeteta[0]->Scale(nwjet); 
hists_topmass[0]->Scale(nwjet); 
hists_toppt[0]->Scale(nwjet);
hists_topeta[0]->Scale(nwjet);
hists_topphotonmass[0]->Scale(nwjet);

double nwphjet=1101.23/hists_muoneta[3]->Integral();
hists_photonpt[3]->Scale(nwphjet); 
hists_photoneta[3]->Scale(nwphjet); 
hists_muonpt[3]->Scale(nwphjet);
hists_muoneta[3]->Scale(nwphjet); 
hists_jetpt[3]->Scale(nwphjet);
hists_jeteta[3]->Scale(nwphjet); 
hists_topmass[3]->Scale(nwphjet); 
hists_toppt[3]->Scale(nwphjet);
hists_topeta[3]->Scale(nwphjet);
hists_topphotonmass[3]->Scale(nwphjet);
...
hists_photonpt[20]->GetXaxis()->SetTitle("PT_{#gamma}");
hists_photonpt[20]->GetYaxis()->SetTitle("NEVENTS");
hists_photonpt[20]->GetXaxis()->SetTitleOffset(0.80);
hists_photonpt[20]->Draw();
hists_photonpt[18]->SetFillColor(kOrange-2);
hists_photonpt[18]->Draw("same");
hists_photonpt[17]->SetFillColor(kViolet-7);
hists_photonpt[17]->Draw("same");
...
TLegend* leg = new TLegend(0.35,0.6,0.85,0.90);
  ...
  leg->SetFillColor ( 0);
  leg->SetBorderSize( 0);
  leg->AddEntry( hists_photonpt[0], "W JET"                           , "F");
...
hists_photoneta[0]->SetFillColor(kBlue-4);
hists_photoneta[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_muoneta[0]->SetFillColor(kBlue-4);
hists_muoneta[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_jetpt[0]->SetFillColor(kBlue-4);
hists_jetpt[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_jeteta[0]->SetFillColor(kBlue-4);
hists_jeteta[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_topmass[20]->GetXaxis()->SetTitle("m_{top}");
hists_topmass[20]->GetYaxis()->SetTitle("NEVENTS");
...
hists_topmass[0]->SetFillColor(kBlue-4);
hists_topmass[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_toppt[0]->SetFillColor(kBlue-4);
hists_toppt[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_topeta[0]->SetFillColor(kBlue-4);
hists_topeta[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
...
hists_topphotonmass[0]->SetFillColor(kBlue-4);
hists_topphotonmass[0]->Draw("same");
//hists_photonpt[21]->SetFillColor(kRed+3);
