...
float scales[] = {0.628,0.0978,34.01,6.133,1.04,0.32,0.02,0.002,0.0961,0.0253,0.0224,0.0145,0.0125,0.0160,0.0158,0.0341,0.0341,0.0341,
...
TH2F *H_etapeakbarrel = new TH2F("H_etapeak","#sigma_{i#eta i#eta} vs eta for WJET (BARREL)",100,-3,3,100,0.,0.08);
TH2F *H_etapeakendcap = new TH2F("H_etapeak","#sigma_{i#eta i#eta} vs eta for WJET (ENDCAP)",100,-3,3,100,0.,0.08);

TH2F *H_sigmacoswgamma = new TH2F("H_sigmacoswgamma","#sigma_{i#eta i#eta} vs cosWgamma for WJET ",100,-3,3,100,-1,1);
TH2F *H_sigmacoswgammadata = new TH2F("H_sigmacoswgamma","#sigma_{i#eta i#eta} vs cosWgamma for DATA ",100,-3,3,100,-1,1);

TH1F *eta = new TH1F("eta","eta for DATA",100,-3,3);
TH1F *coswgamma= new TH1F("cos","cosw gamma for DATA",20,-1,1);
TH1F *etawjet = new TH1F("eta","eta for WJET",140,-3,3);
TH2F *H_etapeakendcapdata = new TH2F("H_etapeak","#sigma_{i#eta i#eta} vs eta for data (ENDCAP)",100,-3,3,100,0.,0.08);
//float scales[] = {0.67*0.528,0.0978,34.01,6.133,1.04,0.32,0.02,0.002,1.17*0.0961,0.0253,0.0224,0.0145,0.0125,0.0160,0.0158,0.0341,0.0341,0.0341,
...
hists_topmass.push_back(new TH1F(  std::string("top_mass").append(samples_[idx]).c_str(), std::string("top_mass").append(samples_[idx]).c_str() , 20, 70, 370.));
...
hists_sigmaietaieta.push_back(new TH1F(  std::string("sigmaietaieta").append(samples_[idx]).c_str(), std::string("sigmaietaieta").append(samples_[idx]).c_str() ,32, 0, 0.1));
hists_sigmaietaieta[idx]->Sumw2();

hists_HOE.push_back(new TH1F(  std::string("HOE").append(samples_[idx]).c_str(), std::string("HOE").append(samples_[idx]).c_str() ,8, 0, 0.05));
hists_HOE[idx]->Sumw2();
}
...
hists_sigmaietaieta.push_back(new TH1F(  std::string("sigmaietaieta").append(datasamplesreverse_[idx]).c_str(), std::string("sigmaietaieta").append(datasamplesreverse_[idx]).c_str() ,32, 0, 0.1));
hists_sigmaietaieta[idx]->Sumw2();
...
hists_sigmaietaieta.push_back(new TH1F(  std::string("sigmaietaieta").append(samplesreverse_[idx]).c_str(), std::string("sigmaietaieta").append(samplesreverse_[idx]).c_str() ,32, 0, 0.1));
hists_sigmaietaieta[idx]->Sumw2();
...
//	hists_Nvertex[idx] ->Fill( (*myNvertex)[0],finalweight *scales[idx]);
//	hists_NvertexnoPU[idx] ->Fill( (*myNvertex)[0],(finalweight/(*mypileupSF)[0])*scales[idx]);

	hists_Nvertex[idx] ->Fill( (*myNvertex)[0],19.145*(*mypileupSF)[0]*scales[idx]);
	hists_NvertexnoPU[idx] ->Fill( (*myNvertex)[0],19.145*scales[idx]);
...
//}
/*
if (samples_[idx] =="WJET.root") H_ch->Fill((*mysigmaietaieta)[0],(*mypfChargedPU )[0]);
if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) <1.444) H_chbarrel->Fill((*mysigmaietaieta)[0],(*mypfChargedPU )[0]);
if (samples_[idx] =="WJET.root"&& abs((*myetaphoton )[0]) >1.444) H_chendcap->Fill((*mysigmaietaieta)[0],(*mypfChargedPU )[0]);

if (samples_[idx] =="WJET.root") H_ph->Fill((*mysigmaietaieta)[0],(*mypfGammaPU )[0]);
if (samples_[idx] =="WJET.root"&& abs((*myetaphoton )[0]) <1.444) H_phbarrel->Fill((*mysigmaietaieta)[0],(*mypfGammaPU )[0]);
if (samples_[idx] =="WJET.root"&& abs((*myetaphoton )[0]) >1.444) H_phendcap->Fill((*mysigmaietaieta)[0],(*mypfGammaPU )[0]);
*/

if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) <1.444 ) H_etapeakbarrel->Fill((*myetaphoton )[0],(*mysigmaietaieta)[0]);
if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) >1.444) H_etapeakendcap->Fill((*myetaphoton )[0],(*mysigmaietaieta)[0]);

if (samples_[idx] =="WJET.root" ) H_sigmacoswgamma->Fill((*myetaphoton)[0],(*mycoswphoton)[0] );


//if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) >1.444 && (*mysigmaietaieta)[0] >0.031  ) etawjet->Fill((*myetaphoton)[0]);
//if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) <1.444 && (*mysigmaietaieta)[0] >0.011 ) etawjet->Fill((*myetaphoton)[0]);

if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) >1.444 && (*mysigmaietaieta)[0] >0.031 && (*mypfChargedPU )[0]<0.7 ) etawjet->Fill((*myetaphoton)[0]);

if (samples_[idx] =="WJET.root" && abs((*myetaphoton )[0]) <1.444 && (*mysigmaietaieta)[0] >0.011 && (*mypfChargedPU )[0]<0.5 ) etawjet->Fill((*myetaphoton)[0]);

if ( (*mybjetmultiplicity )[0]==1 && samples_[idx]=="SIGNALtGu.root") hists_topmass[idx] ->Fill( (*mymasstop )[0],finalweight *scales[idx]);
if (samples_[idx]!="SIGNALtGu.root") hists_topmass[idx] ->Fill( (*mymasstop )[0],finalweight *scales[idx]);
...
//	if ((*mymasstop )[0]>130 && (*mymasstop )[0]<220 ) {
	...
	hists_sigmaietaieta[idx+samples_.size()] ->Fill( (*mysigmaietaieta)[0]);
	hists_HOE[idx+samples_.size()] ->Fill( (*myHOE)[0]);
...
//	if ((*mymasstop )[0]>130 && (*mymasstop )[0]<220 ) {
//	if ((*myHOE )[0]<0.05 ) {
//	if (((*myetaphoton )[0]<1.444 && (*mypfChargedPU )[0]<0.7) || ((*myetaphoton )[0]>1.56 && (*mypfChargedPU )[0]<0.5)) {
//	if (((*myetaphoton )[0]<1.444 && (*mypfNeutralPU )[0]<(0.4+0.04*(*myptphoton)[0])) || ((*myetaphoton )[0]>1.56 && (*mypfNeutralPU )[0]<(1.5+0.04*(*myptphoton)[0]))) {
//	if (((*myetaphoton )[0]<1.444 && (*mypfGammaPU )[0]<(0.5+0.005*(*myptphoton)[0])) || ((*myetaphoton )[0]>1.56 && (*mypfGammaPU )[0]<(0.5+0.005*(*myptphoton)[0]))) {
	...
	hists_sigmaietaieta[idx+samples_.size()+3] ->Fill( (*mysigmaietaieta)[0]);
	hists_HOE[idx+samples_.size()+3] ->Fill( (*myHOE)[0]);
...
//	if (((*myetaphoton )[0]<1.444 && (*mypfGammaPU )[0]<(0.5+0.005*(*myptphoton)[0])) || ((*myetaphoton )[0]>1.56 && (*mypfGammaPU )[0]<(0.5+0.005*(*myptphoton)[0]))) {
	...
	hists_sigmaietaieta[idx+samples_.size()+6] ->Fill( (*mysigmaietaieta)[0],finalweight *scales[idx]);
	hists_HOE[idx+samples_.size()+6] ->Fill( (*myHOE)[0],finalweight *scales[idx]);
//}}
	}
	delete myptphoton;
	delete myetaphoton;
...
for(unsigned int idx=2; idx<samplesreverse_.size(); ++idx){
 ...
 //       hists_Nvertex[idx+samples_.size()+6]->Add(hists_Nvertex[idx+samples_.size()+5]);
	...
	hists_HOE[idx+samples_.size()+6]->Add(hists_HOE[idx+samples_.size()+5]);
}
...
//        hists_Nvertex[idx+samples_.size()+3]->Add(hists_Nvertex[idx+samples_.size()+2]);
	...
	hists_sigmaietaieta[idx+samples_.size()+3]->Add(hists_sigmaietaieta[idx+samples_.size()+2]);
	hists_HOE[idx+samples_.size()+3]->Add(hists_HOE[idx+samples_.size()+2]);
}
...
hists_CSV[samples_.size()+5]->Add(hists_CSV[samples_.size()+samplesreverse_.size()+5],-1);
	...
	hists_HOE[samples_.size()+5]->Add(hists_HOE[samples_.size()+samplesreverse_.size()+5],-1);
...
hists_topmass[samples_.size()+5]->Scale(620.326/hists_topmass[samples_.size()+5]->Integral()); 
...
hists_HOE[samples_.size()+5]->Scale(nwjet);

//hists_sigmaietaieta[0]->Scale(219.373/hists_sigmaietaieta[0]->Integral());
...
hists_topmass[8]->Scale(3173.42/hists_topmass[8]->Integral()); 
...
//hists_sigmaietaieta[8]->Scale(nwphjet);
hists_HOE[8]->Scale(nwphjet);
/*
...
for(unsigned int idx=1; idx<datasamples_.size(); ++idx){
	...
	hists_sigmaietaieta[idx+samples_.size()]->Add(hists_sigmaietaieta[idx+samples_.size()-1]);
	hists_HOE[idx+samples_.size()]->Add(hists_HOE[idx+samples_.size()-1]);
}
...
cout<<"       0000000000000000000000000000000          "<<hists_photoneta[samples_.size()+2]->Integral()<<endl;
...
hs6->Draw("hist");
hs6->SetMaximum(1.2*hists_jeteta[samples_.size()+2]->GetMaximum());
...
hists_topmass[2+5]->SetFillColor(19);
hs7->Add(hists_topmass[2+5]);
hists_topmass[3+5]->SetFillColor(kGreen+1);
hs7->Add(hists_topmass[3+5]);
hists_topmass[5+5]->Add(hists_topmass[4+5]);
hists_topmass[6+5]->Add(hists_topmass[5+5]);
hists_topmass[7+5]->Add(hists_topmass[6+5]);
hists_topmass[8+5]->Add(hists_topmass[7+5]);
hists_topmass[9+5]->Add(hists_topmass[8+5]);
hists_topmass[9+5]->SetFillColor(kAzure+10);
hs7->Add(hists_topmass[9]);
hists_topmass[11+5]->Add(hists_topmass[10+5]);
hists_topmass[12+5]->Add(hists_topmass[11+5]);
hists_topmass[12+5]->SetFillColor(6);
hs7->Add(hists_topmass[12+5]);
hists_topmass[13+5]->SetFillColor(32);
hs7->Add(hists_topmass[13+5]);
hists_topmass[14+5]->SetFillColor(kSpring-9);
hs7->Add(hists_topmass[14+5]);
hists_topmass[16+5]->Add(hists_topmass[15+5]);
hists_topmass[17+5]->Add(hists_topmass[16+5]);
hists_topmass[17+5]->SetFillColor(kViolet-7);
hs7->Add(hists_topmass[17+5]);
hists_topmass[18+5]->SetFillColor(kOrange-2);
hs7->Add(hists_topmass[18+5]);
hists_topmass[20+5]->Add(hists_topmass[19+5]);
hists_topmass[20+5]->SetFillColor(kYellow+3);
hs7->Add(hists_topmass[20+5]);
...
hists_topmass[21+5]->SetLineColor(kRed+3);
hists_topmass[21+5]->SetLineWidth(3);
hists_topmass[21+5]->Draw("same");
...
TLine *line1 = new TLine(130, 0, 130,1.1* hists_topmass[samples_.size()+2]->GetMaximum());
    line1->SetLineColor(1);
    line1->SetLineWidth(2);
    line1->Draw("same");
TLine *line2 = new TLine(220, 0, 220, 1.1*hists_topmass[samples_.size()+2]->GetMaximum());
    line2->SetLineColor(1);
    line2->SetLineWidth(2);
    line2->Draw("same");
TLine *line3 = new TLine(130,1.1* hists_topmass[samples_.size()+2]->GetMaximum(), 220, 1.1*hists_topmass[samples_.size()+2]->GetMaximum());
...
hs11->GetXaxis()->SetTitle("#sigma_{i#eta i#eta}");
...
hs111->GetXaxis()->SetTitle("#sigma_{i#eta i#eta}");
...
hs13->Draw("hist");
hs13->SetMaximum(1.3*hists_deltaphimetphoton[samples_.size()+2]->GetMaximum());
...
hs14->Draw("hist");
hs14->SetMaximum(1.2*hists_deltarphotonmuon[samples_.size()+2]->GetMaximum());
...
hs15->Draw("hist");
hs15->SetMaximum(1.2*hists_deltarphotonbjet[samples_.size()+2]->GetMaximum());
...
hs16->Draw("hist");
hs16->SetMaximum(1.2*hists_jetmulti[samples_.size()+2]->GetMaximum());
...
hs17->Draw("hist");
hs17->SetMaximum(1.2*hists_costopphoton[samples_.size()+2]->GetMaximum());
...
TH1F *sum_h18= new TH1F ( *hists_sigmaietaieta[0] ) ;
for(unsigned int idx=1; idx<samples_.size()-1; ++idx){
sum_h18->Add(hists_sigmaietaieta[idx],1);
}
...
hs18->Draw("hist");
hs18->SetMaximum(1.2*hists_sigmaietaieta[samples_.size()+2]->GetMaximum());
hs18->GetXaxis()->SetTitle("#sigma_{i#eta i#eta}");
hs18->GetYaxis()->SetTitle("NEVENTS(signal region)");

hists_sigmaietaieta[21+5]->SetLineColor(kRed+3);
hists_sigmaietaieta[21+5]->SetLineWidth(3);
hists_sigmaietaieta[21+5]->Draw("histsame");

hists_sigmaietaieta[samples_.size()+2]->SetLineWidth(3.);
hists_sigmaietaieta[samples_.size()+2]->SetLineColor(kBlack);
hists_sigmaietaieta[samples_.size()+2]->SetMarkerColor(kBlack);
hists_sigmaietaieta[samples_.size()+2]->SetMarkerStyle(20.);
hists_sigmaietaieta[samples_.size()+2]->Draw("esame");
sum_h18->SetFillColor(2);
sum_h18->SetFillStyle(3013);
sum_h18->Draw("e2same");
leg->Draw("same");

  TCanvas *c19 = new TCanvas("c19","sigmaietaietaCR",900,700);
  c19->cd(0);
THStack *hs19 = new THStack("hs19","sigmaietaietaCR");
hists_sigmaietaieta[samples_.size()+6+0]->SetFillColor(kBlue-4);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+0]);
hists_sigmaietaieta[samples_.size()+6+1]->SetFillColor(kOrange+7);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+1]);
hists_sigmaietaieta[samples_.size()+6+3]->Add(hists_sigmaietaieta[samples_.size()+6+2]);
hists_sigmaietaieta[samples_.size()+6+4]->Add(hists_sigmaietaieta[samples_.size()+6+3]);
hists_sigmaietaieta[samples_.size()+6+5]->Add(hists_sigmaietaieta[samples_.size()+6+4]);
hists_sigmaietaieta[samples_.size()+6+6]->Add(hists_sigmaietaieta[samples_.size()+6+5]);
hists_sigmaietaieta[samples_.size()+6+7]->Add(hists_sigmaietaieta[samples_.size()+6+6]);
hists_sigmaietaieta[samples_.size()+6+7]->SetFillColor(19);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+7]);
hists_sigmaietaieta[samples_.size()+6+8]->SetFillColor(kGreen+1);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+8]);
hists_sigmaietaieta[samples_.size()+6+10]->Add(hists_sigmaietaieta[samples_.size()+6+9]);
hists_sigmaietaieta[samples_.size()+6+6+5]->Add(hists_sigmaietaieta[samples_.size()+6+5+5]);
hists_sigmaietaieta[samples_.size()+6+7+5]->Add(hists_sigmaietaieta[samples_.size()+6+6+5]);
hists_sigmaietaieta[samples_.size()+6+8+5]->Add(hists_sigmaietaieta[samples_.size()+6+7+5]);
hists_sigmaietaieta[samples_.size()+6+9+5]->Add(hists_sigmaietaieta[samples_.size()+6+8+5]);
hists_sigmaietaieta[samples_.size()+6+9+5]->SetFillColor(kAzure+10);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+9+5]);
hists_sigmaietaieta[samples_.size()+6+11+5]->Add(hists_sigmaietaieta[samples_.size()+6+10+5]);
hists_sigmaietaieta[samples_.size()+6+12+5]->Add(hists_sigmaietaieta[samples_.size()+6+11+5]);
hists_sigmaietaieta[samples_.size()+6+12+5]->SetFillColor(6);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+12+5]);
hists_sigmaietaieta[samples_.size()+6+13+5]->SetFillColor(32);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+13+5]);
hists_sigmaietaieta[samples_.size()+6+14+5]->SetFillColor(kSpring-9);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+14+5]);
hists_sigmaietaieta[samples_.size()+6+16+5]->Add(hists_sigmaietaieta[samples_.size()+6+15+5]);
hists_sigmaietaieta[samples_.size()+6+17+5]->Add(hists_sigmaietaieta[samples_.size()+6+16+5]);
hists_sigmaietaieta[samples_.size()+6+17+5]->SetFillColor(kViolet-7);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+17+5]);
hists_sigmaietaieta[samples_.size()+6+18+5]->SetFillColor(kOrange-2);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+18+5]);
hists_sigmaietaieta[samples_.size()+6+20+5]->Add(hists_sigmaietaieta[samples_.size()+6+19+5]);
hists_sigmaietaieta[samples_.size()+6+20+5]->SetFillColor(kYellow+3);
hs19->Add(hists_sigmaietaieta[samples_.size()+6+20+5]);

hs19->Draw("hist");
hs19->SetMaximum(1.2*hists_sigmaietaieta[samples_.size()+5]->GetMaximum());
hs19->GetXaxis()->SetTitle("#sigma_{i#eta i#eta}");
hs19->GetYaxis()->SetTitle("NEVENTS");

hists_sigmaietaieta[samples_.size()+5]->SetLineWidth(3.);
hists_sigmaietaieta[samples_.size()+5]->SetLineColor(kBlack);
hists_sigmaietaieta[samples_.size()+5]->SetMarkerColor(kBlack);
hists_sigmaietaieta[samples_.size()+5]->SetMarkerStyle(20.);
hists_sigmaietaieta[samples_.size()+5]->Draw("esame");


TH1F *sum_h20= new TH1F ( *hists_HOE[1] ) ;
for(unsigned int idx=2; idx<samples_.size()-1; ++idx){
sum_h20->Add(hists_HOE[idx],1);
}
sum_h20->Add(hists_HOE[samples_.size()+5],1);

  TCanvas *c20 = new TCanvas("c20","HOE",900,700);
  c20->cd(0);
THStack *hs20 = new THStack("hs20","HOE");
hists_HOE[samples_.size()+5]->SetFillColor(kBlue-4);
hs20->Add(hists_HOE[samples_.size()+5]);
hists_HOE[1]->SetFillColor(kOrange+7);
hs20->Add(hists_HOE[1]);
hists_HOE[3]->Add(hists_HOE[2]);
hists_HOE[4]->Add(hists_HOE[3]);
hists_HOE[5]->Add(hists_HOE[4]);
hists_HOE[6]->Add(hists_HOE[5]);
hists_HOE[7]->Add(hists_HOE[6]);
hists_HOE[7]->SetFillColor(19);
hs20->Add(hists_HOE[7]);
hists_HOE[8]->SetFillColor(kGreen+1);
hs20->Add(hists_HOE[8]);
hists_HOE[10]->Add(hists_HOE[9]);
hists_HOE[6+5]->Add(hists_HOE[5+5]);
hists_HOE[7+5]->Add(hists_HOE[6+5]);
hists_HOE[8+5]->Add(hists_HOE[7+5]);
hists_HOE[9+5]->Add(hists_HOE[8+5]);
hists_HOE[9+5]->SetFillColor(kAzure+10);
hs20->Add(hists_HOE[9+5]);
hists_HOE[11+5]->Add(hists_HOE[10+5]);
hists_HOE[12+5]->Add(hists_HOE[11+5]);
hists_HOE[12+5]->SetFillColor(6);
hs20->Add(hists_HOE[12+5]);
hists_HOE[13+5]->SetFillColor(32);
hs20->Add(hists_HOE[13+5]);
hists_HOE[14+5]->SetFillColor(kSpring-9);
hs20->Add(hists_HOE[14+5]);
hists_HOE[16+5]->Add(hists_HOE[15+5]);
hists_HOE[17+5]->Add(hists_HOE[16+5]);
hists_HOE[17+5]->SetFillColor(kViolet-7);
hs20->Add(hists_HOE[17+5]);
hists_HOE[18+5]->SetFillColor(kOrange-2);
hs20->Add(hists_HOE[18+5]);
hists_HOE[20+5]->Add(hists_HOE[19+5]);
hists_HOE[20+5]->SetFillColor(kYellow+3);
hs20->Add(hists_HOE[20+5]);

hs20->Draw("hist");
hs20->SetMaximum(1.2*hists_HOE[samples_.size()+2]->GetMaximum());
hs20->GetXaxis()->SetTitle("Single Tower H/E");
hs20->GetYaxis()->SetTitle("NEVENTS");

hists_HOE[21+5]->SetLineColor(kRed+3);
hists_HOE[21+5]->SetLineWidth(3);
hists_HOE[21+5]->Draw("histsame");

hists_HOE[samples_.size()+2]->SetLineWidth(3.);
hists_HOE[samples_.size()+2]->SetLineColor(kBlack);
hists_HOE[samples_.size()+2]->SetMarkerColor(kBlack);
hists_HOE[samples_.size()+2]->SetMarkerStyle(20.);
hists_HOE[samples_.size()+2]->Draw("esame");
sum_h20->SetFillColor(2);
sum_h20->SetFillStyle(3013);
sum_h20->Draw("e2same");
...
H_phendcap->Draw("colz");
  ...
  TCanvas *c28 = new TCanvas("c28","28",900,700);
  c28->cd(0);
H_etapeakbarrel->GetXaxis()->SetTitle("#eta ");
H_etapeakbarrel->GetYaxis()->SetTitle("#sigma_{i#eta i#eta}");
H_etapeakbarrel->Draw("colz");

  TCanvas *c29 = new TCanvas("c29","29",900,700);
  c29->cd(0);
H_etapeakendcap->GetXaxis()->SetTitle("#eta ");
H_etapeakendcap->GetYaxis()->SetTitle("#sigma_{i#eta i#eta}");
H_etapeakendcap->Draw("colz");


  TCanvas *c30 = new TCanvas("c30","30",900,700);
  c30->cd(0);
H_sigmacoswgamma->GetXaxis()->SetTitle("#eta ");
H_sigmacoswgamma->GetYaxis()->SetTitle("cos(W,gamma)");
H_sigmacoswgamma->Draw("colz");
...
H_etapeakendcapdata->Draw("colz");
  ...
  TCanvas *c33 = new TCanvas("c33","33",900,700);
  c33->cd(0);
etawjet->GetXaxis()->SetTitle("#eta ");
etawjet->GetYaxis()->SetTitle("NEvents");
etawjet->Draw("");
