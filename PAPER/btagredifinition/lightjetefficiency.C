...
*/
variables2_.push_back("lighttageffL");
variables2_.push_back("lighttageffM");
variables2_.push_back("lighttageffT");
...
hists.push_back((TH1F*)files[idx]->Get((std::string("analyzestep2/").append(variables2_[ii]).c_str())));
//hists.push_back((TH1F*)files[idx]->Get((std::string("STEP1/").append(variables2_[ii]).c_str())));
}
...
effi[i] =finaleff[i]; }
   ...
   cout<<"loose        "<<gr->Eval(1.09*grREV->Eval(0.244))<<endl;
   cout<<"medium        "<<gr->Eval(1.16*grREV->Eval(0.679))<<endl;
   cout<<"tight        "<<gr->Eval(1.21*grREV->Eval(0.898))<<endl;


   cout<<"the new working points for SF UP"<<endl;
   cout<<"loose        "<<gr->Eval((1.09+0.0806)*grREV->Eval(0.244))<<endl;
   cout<<"medium        "<<gr->Eval((1.16+0.1414)*grREV->Eval(0.679))<<endl;
   cout<<"tight        "<<gr->Eval((1.21+0.211)*grREV->Eval(0.898))<<endl;
