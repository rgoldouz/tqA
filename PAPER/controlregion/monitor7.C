...
float scales[] = {0.0961,0.0978,1.491,0.628,0.0253,0.0224,0.0145,0.0125,0.0160,0.0158,0.0341,0.0341,0.0341,0.020,0.0017,0.0055,0.0032,0.00084,0.02,0.032,0.024,4*0.0169};
...
datahists.push_back((TH1F*)datafiles[idx]->Get((std::string("analyzestep2/").append(variables2_[i]).c_str())));
}
float lumi = 1;
//float lumi = 4.429;
...
hists[20]->SetMaximum(2*datahists[1]->GetMaximum());
