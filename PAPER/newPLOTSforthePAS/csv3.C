...
hists[idx] ->Fill(Bmodification((*mycvsdiscriminant)[0],(*myjetmatchinginfo)[0],0),finalweight );
...
SBhists[idx] ->Fill( Bmodification((*mycvsdiscriminant)[0],(*myjetmatchinginfo)[0],0),finalweight );
...
hs1->GetXaxis()->SetTitle("b-Jet Discriminator");
