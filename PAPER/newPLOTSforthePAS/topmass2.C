...
hists[idx] ->Fill( (*mymasstop)[0],finalweight );
...
SBhists[idx] ->Fill( (*mymasstop)[0],finalweight );
...
revDATAhists[3]->Fill( (*mymasstop)[0]);
}
...
h_ratio->GetXaxis()->SetTitle("m_{top} (GeV)");
