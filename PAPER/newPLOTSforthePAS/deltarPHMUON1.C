...
void deltarPHMUON1( TString myMethodList = "" ) 
{   
...
hists[idx] ->Fill( (*mydeltaRphotonmuon)[0] ,finalweight*scales[idx] );
if (samples_[idx]=="WPHJET.root") insidewphjet=insidewphjet+finalweight;
}
else {
SBhists[idx] ->Fill( (*mydeltaRphotonmuon)[0] ,finalweight*scales[idx] );
...
else {revDATAhists[3]->Fill( (*mydeltaRphotonmuon)[0] );
...
if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup){
Shists[0] ->Fill( (*mydeltaRphotonmuon)[0],finalweight*signalscales[phi]);
Shists[1] ->Fill((*mydeltaRphotonmuon)[0],finalweight*signalscales[phi]);
Shists[2] ->Fill( (*mydeltaRphotonmuon)[0],finalweight*signalscales[phi]);
Shists[3] ->Fill( (*mydeltaRphotonmuon)[0],finalweight*signalscales[phi]);
Shists[4] ->Fill( (*mydeltaRphotonmuon)[0],finalweight*signalscales[phi]);
}
}
...
/////////////////////////////////////////////////////////////////////////
TFile *target  = new TFile( "DELTARIPHMUON.root","RECREATE" );
  hList->Write();
   target->Close();
}
