...
if(sqrt(pow((*myetaphoton )[0]- 1.6,2)+pow((*myphiphoton )[0]+2.1,2))>0.05 && sqrt(pow((*myetaphoton )[0]-1.65,2)+pow((*myphiphoton )[0]-2.1,2))>0.05){
if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup){
hists[idx] ->Fill( (*myptphoton)[0],finalweight );
...
SBhists[idx] ->Fill( (*myptphoton)[0],finalweight );
...
if(sqrt(pow((*myetaphoton )[0]+1.76,2)+pow((*myphiphoton )[0]-1.37,2))>0.05 && sqrt(pow((*myetaphoton )[0]-2.37,2)+pow((*myphiphoton )[0]-2.69,2))>0.05){
if(sqrt(pow((*myetaphoton )[0]- 1.6,2)+pow((*myphiphoton )[0]+2.1,2))>0.05 && sqrt(pow((*myetaphoton )[0]-1.65,2)+pow((*myphiphoton )[0]-2.1,2))>0.05){
if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup) datahists[idx] ->Fill( (*myptphoton)[0] );
else datahists[3]->Fill(  (*myptphoton)[0] );
}}}
delete myptphoton;
delete myetaphoton;
delete myptmuon;
...
hs1->GetYaxis()->SetTitle("Events / 10 GeV");
...
h_ratio->GetXaxis()->SetTitle("Photon P_{T} (GeV)");
