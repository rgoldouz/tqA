...
void Gammapt1( TString myMethodList = "" ) 
{   
...
hists[idx] ->Fill( (*myptphoton)[0] ,finalweight*scales[idx] );
if (samples_[idx]=="WPHJET.root") insidewphjet=insidewphjet+finalweight;
}
else {
SBhists[idx] ->Fill( (*myptphoton)[0] ,finalweight*scales[idx] );
...
else {revDATAhists[3]->Fill( (*myptphoton)[0] );
...
if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup){
Shists[0] ->Fill( (*myptphoton)[0],finalweight*signalscales[phi]);
Shists[1] ->Fill((*myptphoton)[0],finalweight*signalscales[phi]);
Shists[2] ->Fill( (*myptphoton)[0],finalweight*signalscales[phi]);
Shists[3] ->Fill( (*myptphoton)[0],finalweight*signalscales[phi]);
Shists[4] ->Fill( (*myptphoton)[0],finalweight*signalscales[phi]);
}
}
...
/////////////////////////////////////////////////////////////////////////
TFile *target  = new TFile( "GAMMAPT.root","RECREATE" );
  hList->Write();
   target->Close();
}
