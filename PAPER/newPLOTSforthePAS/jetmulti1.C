...
void jetmulti1( TString myMethodList = "" ) 
{   
...
hists[idx] ->Fill( (*myjetmultiplicity)[0] ,finalweight*scales[idx] );
if (samples_[idx]=="WPHJET.root") insidewphjet=insidewphjet+finalweight;
}
else {
SBhists[idx] ->Fill( (*myjetmultiplicity)[0] ,finalweight*scales[idx] );
...
else {revDATAhists[3]->Fill( (*myjetmultiplicity)[0] );
...
if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup){
Shists[0] ->Fill( (*myjetmultiplicity)[0],finalweight*signalscales[phi]);
Shists[1] ->Fill((*myjetmultiplicity)[0],finalweight*signalscales[phi]);
Shists[2] ->Fill( (*myjetmultiplicity)[0],finalweight*signalscales[phi]);
Shists[3] ->Fill( (*myjetmultiplicity)[0],finalweight*signalscales[phi]);
Shists[4] ->Fill( (*myjetmultiplicity)[0],finalweight*signalscales[phi]);
}
}
...
/////////////////////////////////////////////////////////////////////////
TFile *target  = new TFile( "JETMULTI.root","RECREATE" );
  hList->Write();
   target->Close();
}
