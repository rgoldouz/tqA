...
hs1->Add(other);
hs1->Draw("hist");
hs1->SetMaximum(2.1*datahists[2]->GetMaximum());
...
hs1->GetYaxis()->SetTitleOffset(0.85);
hs1->GetYaxis()->SetLabelSize(0.051);
hs1->GetXaxis()->SetTitleSize(0.062);
hs1->GetXaxis()->SetTitleFont(22);
hs1->GetXaxis()->SetTitleOffset(0.85);
hs1->GetXaxis()->SetLabelSize(0.051);
...
gae2->SetFillStyle(3003);
   ...
   gae->Draw("e2same");
TLegend* leg = new TLegend(0.55,0.53,0.80,0.88);
  leg->SetFillStyle ( 0);
  leg->SetFillColor ( 0);
  leg->SetBorderSize( 0);
