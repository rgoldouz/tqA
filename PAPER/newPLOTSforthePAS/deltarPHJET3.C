...
void deltarPHJET3() 
{   
  TString sysname ="DELTARIPHJET.root";
  TFile *sysinput(0);
...
hists[idx] ->Fill( (*mydeltaRphotonjet)[0],finalweight );
...
SBhists[idx] ->Fill( (*mydeltaRphotonjet)[0],finalweight );
...
revDATAhists[3]->Fill( (*mydeltaRphotonjet)[0]);
}
}
}}
...
hs1->GetXaxis()->SetTitle("#DeltaR (Photon,b-jet)");
