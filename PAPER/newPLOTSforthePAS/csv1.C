...
void csv1( TString myMethodList = "" ) 
{   
...
hists[idx] ->Fill( correctbtag ,finalweight*scales[idx] );
if (samples_[idx]=="WPHJET.root") insidewphjet=insidewphjet+finalweight;
}
else {
SBhists[idx] ->Fill(correctbtag ,finalweight*scales[idx] );
...
else {revDATAhists[3]->Fill( (*mycvsdiscriminant)[0] );
...
if((*mymasstop )[0]>mtopdown && (*mymasstop )[0]<mtopup){
Shists[0] ->Fill( (*mycvsdiscriminant)[0],finalweight*signalscales[phi]);
Shists[1] ->Fill((*mycvsdiscriminant)[0],finalweight*signalscales[phi]);
Shists[2] ->Fill( (*mycvsdiscriminant)[0],finalweight*signalscales[phi]);
Shists[3] ->Fill( (*mycvsdiscriminant)[0],finalweight*signalscales[phi]);
Shists[4] ->Fill( (*mycvsdiscriminant)[0],finalweight*signalscales[phi]);
}
}
...
/////////////////////////////////////////////////////////////////////////
TFile *target  = new TFile( "CSV.root","RECREATE" );
  hList->Write();
   target->Close();
}
