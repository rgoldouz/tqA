...
//	hists_muonpt[idx] ->Fill((*myptmuon )[0] ,(finalweight/(*mypileupSF)[0])*scales[idx] );
	...
	else{if (samples_[idx]=="WPHJET.root") outsidewphjet=outsidewphjet+finalweight;}
}
//	}
	}
	delete myptphoton;
...
fwjet=insidewjet/(insidewjet+outsidewjet);
fwphjet=insidewphjet/(outsidewphjet+insidewphjet);

double nwjet=(fwjet*219.373)/hists_muoneta[samples_.size()+5]->Integral();
...
*/
double nwphjet=(fwphjet*1112.2)/hists_muoneta[8]->Integral();
hists_photonpt[8]->Scale((fwphjet*1112.2)/hists_photonpt[8]->Integral()); 
...
hs1->Draw("hist");
hs1->SetMaximum(1.3*hists_photonpt[samples_.size()+2]->GetMaximum());
...
cout<<"__________________"<<hists_photonpt[samples_.size()+2]->Integral()<<endl;
...
hs2->Draw("hist");
hs2->SetMaximum(1.3*hists_photoneta[samples_.size()+2]->GetMaximum());
...
hs3->Draw("hist");
hs3->SetMaximum(1.3*hists_muonpt[samples_.size()+2]->GetMaximum());
...
hs4->Draw("hist");
hs4->SetMaximum(1.3*hists_muoneta[samples_.size()+2]->GetMaximum());
...
hs5->Draw("hist");
hs5->SetMaximum(1.3*hists_jetpt[samples_.size()+2]->GetMaximum());
...
hs6->Draw("hist");
hs6->SetMaximum(1.3*hists_jeteta[samples_.size()+2]->GetMaximum());
...
hs7->Draw();
hs7->SetMaximum(1.3*hists_topmass[samples_.size()+2]->GetMaximum());
...
hs12->Draw("hist");
hs12->SetMaximum(1.3*hists_CSV[samples_.size()+2]->GetMaximum());
...
hs14->Draw("hist");
hs14->SetMaximum(1.3*hists_deltarphotonmuon[samples_.size()+2]->GetMaximum());
...
hs15->Draw("hist");
hs15->SetMaximum(1.3*hists_deltarphotonbjet[samples_.size()+2]->GetMaximum());
...
hs16->Draw("hist");
hs16->SetMaximum(1.3*hists_jetmulti[samples_.size()+2]->GetMaximum());
...
hs17->Draw("hist");
hs17->SetMaximum(1.3*hists_costopphoton[samples_.size()+2]->GetMaximum());
